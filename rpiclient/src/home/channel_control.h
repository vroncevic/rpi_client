...
#define WIDTH_SCALE_CHANNEL_CONTROL (50)
#define HEIGHT_SCALE_CHANNEL_CONTROL (180)
#define MIN_VALUE_SCALE_CHANNEL_CONTROL (0.0)
#define MAX_VALUE_SCALE_CHANNEL_CONTROL (100.0)
#define STEP_VALUE_SCALE_CHANNEL_CONTROL (1.0)
#define VALUE_SPINNER_ADJUSTMENT_CHANNEL_CONTROL (0.0)
#define LOWER_SPINNER_ADJUSTMENT_CHANNEL_CONTROL (0.0)
#define UPPER_SPINNER_ADJUSTMENT_CHANNEL_CONTROL (100.0)
#define STEP_INCREMENT_SPINNER_ADJUSTMENT_CHANNEL_CONTROL (1.0)
#define PAGE_INCREMENT_SPINNER_ADJUSTMENT_CHANNEL_CONTROL (0.0)
#define PAGE_SIZE_SPINNER_ADJUSTMENT_CHANNEL_CONTROL (0.0)
#define CLIMB_RATE_SPINNER_BUTTON_CHANNEL_CONTROL (1.0)
#define DIGITS_SPINNER_BUTTON_CHANNEL_CONTROL (0)
