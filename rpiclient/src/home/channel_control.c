...
{
    return instance && GTK_IS_VB(instance->control_channel_vertical_bar) ? instance->control_channel_vertical_bar : NULL;
}

GtkWidget* get_scale_channel_control(ChannelControl *instance)
{
    return instance && GTK_IS_SCALE(instance->control_channel_scale) ? instance->control_channel_scale : NULL;
}

GtkWidget* get_spinner_button_channel_control(ChannelControl *instance)
{
    return instance && GTK_IS_SPIN_BUTTON(instance->control_channel_spinner_button) ? instance->control_channel_spinner_button : NULL;
}

GtkWidget* get_check_box_channel_control(ChannelControl *instance)
{
    return instance && GTK_IS_CHECK_BUTTON(instance->control_channel_gpio_check_box) ? instance->control_channel_gpio_check_box : NULL;
}
