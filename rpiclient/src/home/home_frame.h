...
#define Y_POSITION_ACTIVATE_CHANNEL_GET (10)
...
#define Y_POSITION_SPINER_BUTTON_SET (220)
#define START_X_POSITION_ACTIVATE_GPIO_SET (0)
#define Y_POSITION_ACTIVATE_GPIO_SET (190)
#define SHIFT_X_POSITION_SET (125)
