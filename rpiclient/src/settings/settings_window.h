...
#define TABLE_ROW_SPACINGS_TABLE_SETTINGS_WINDOW (10)
#define TABLE_COL_SPACINGS_TABLE_SETTINGS_WINDOW (10)
#define TEXT_FRAME_CONTORL_EXIT_SETTINGS_WINDOW "Exit Operation"
#define TEXT_CHECK_BUTTON_CONTROL_EXIT_SETTINGS_WINDOW "Display Exit Dialog on Quit?"
#define TEXT_FRAME_ENTRY_ADDRESS_SETTINGS_WINDOW "Server IP Address"
#define MAX_LENGTH_ENTRY_ADDRESS_SETTINGS_WINDOW (50)
#define TEXT_EXAMPLE_ENTRY_ADDRESS_SETTINGS_WINDOW " exm: 192.168.1.115"
#define NEW_TEXT_LENGTH_ENTRY_ADDRESS_SETTINGS_WINDOW (-1)
#define START_POSITION_ENTRY_ADDRESS_SETTINGS_WINDOW (0)
#define TEXT_FRAME_ENTRY_PORT_SETTINGS_WINDOW "Server Port Number"
#define MAX_LENGTH_ENTRY_PORT_SETTINGS_WINDOW (50)
#define TEXT_EXAMPLE_ENTRY_PORT_SETTINGS_WINDOW " exm: 9009"
#define NEW_TEXT_LENGTH_ENTRY_PORT_SETTINGS_WINDOW (-1)
#define START_POSITION_ENTRY_PORT_SETTINGS_WINDOW (0)
#define TEXT_BUTTON_OK_HBOX_SETTINGS_WINDOW "OK"
#define TEXT_BUTTON_CANCEL_HBOX_SETTINGS_WINDOW "Cancel"
#define WIDTH_BUTTON_HBOX_SETTINGS_WINDOW (70)
#define HEIGHT_BUTTON_HBOX_SETTINGS_WINDOW (30)
#define SPACING_HBOX_SETTINGS_WINDOW (3)
